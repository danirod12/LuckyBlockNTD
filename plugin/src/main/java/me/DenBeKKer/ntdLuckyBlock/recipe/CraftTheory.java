...
public class CraftTheory {
    ...
    public static Collection<LuckyRecipe> getDefault(LuckyBlockType type) {
        ...
        if (type == LuckyBlockType.ICED) return new ArrayList<>();

        List<LuckyRecipe> list = new ArrayList<>();

        list.add(new LuckyRecipe(type, new LuckyRecipeItem[]{
    ...
    public static List<LuckyRecipe> getFromConfig(LuckyBlockType type) {
