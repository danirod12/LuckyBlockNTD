...
public class VersionCommand implements LBCommand {
    ...
    public CommandResponse execute(CommandSender sender, String label, String[] args) {
        ...
        sender.sendMessage("\u00a78 • \u00a7fRunning version - \u00a7e" + LBMain.getInstance().getVersion() + " \u00a77(" +
                LBMain.getVersionType().getColoredSimpleName() + "\u00a77) " + (LBMain.getInstance().getUpdater().need_update$cache() ?
        ...
        sender.sendMessage("\u00a78 • \u00a7fPlugin author -\u00a7e danirod12 \u00a77(aka DenBeKKer)");
