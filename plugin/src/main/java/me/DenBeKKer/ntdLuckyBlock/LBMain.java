    ...
    private boolean loadNMS() {
        ...
        try {
            switch (MinecraftVersion.getPossibleNMSVersion()) {
                case v1_21_R7: {
                    try {
                        itemTagAdapter = new ItemTag1_21_R7();
                    } catch (Throwable th1) {
                        itemTagAdapter = new ItemTag1_21_Mojang();
                    }
                    return true;
                }
                case v1_21_R6: {
                    itemTagAdapter = new ItemTag1_21_R6();
                    return true;
                }
                case v1_21_R5: {
                ...
                case v1_21_R3: {
                    itemTagAdapter = new ItemTag1_21_R3();
                    return true;
                }
                case v1_21_R2: {
                    itemTagAdapter = new ItemTag1_21_R2();
                    return true;
                }
                case v1_21_R1: {
